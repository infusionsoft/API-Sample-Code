...
$v=new xmlrpcval(array(new xmlrpcval("ABCDEFHIJ"),
...
$v=new xmlrpcval(array("thearray" =>
					   new xmlrpcval(array(new xmlrpcval("ABCDEFHIJ"),
										   new xmlrpcval(1234, 'int'),
										   new xmlrpcval(1, 'boolean'),
					   ...
					   "thestring" =>
					   new xmlrpcval("foobarwhizz"),
					   "thestruct" =>
					   new xmlrpcval(array("one" =>
										   new xmlrpcval(1, 'int'),
										   "two" =>
										   new xmlrpcval(2, 'int')),
									 "struct")
